## 0.7.4-rc2.12 — 2026-09-23

- 初始化与清理归属 Cordis 生命周期，依赖移除后不会复活已卸载的页面。
- 默认存储按精确 profile 隔离；提供离线迁移、原字节备份与唯一归属回执，旧默认数据升级前必须迁移。
- 配套 Core 0.3.12-rc2.29 / Bridge 0.4.1-rc2.11；运行环境 DSH 0.1.5-rc.2 / web。
