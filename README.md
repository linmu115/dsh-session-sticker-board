...
**0.7.4-rc2.8 · DSH 0.1.5-rc.2 · 依赖 Core + DSH Obsidian Bridge**
...
从 [Release v0.7.4-rc2.8](https://github.com/linmu115/dsh-session-sticker-board/releases/tag/v0.7.4-rc2.8) 下载 `dsh-session-sticker-board-0.7.4-rc2.8.tgz`，然后：

```powershell
$env:DSH_HOME = '<你的 DSH_HOME>'
dsh plugin --profile web add ./dsh-session-sticker-board-0.7.4-rc2.8.tgz
```
